...
- **Admin suite** — association editors with per-snippet match exclusions, chapter prose hiding, an image manager, a province-map placement editor (upload a map per province, hand-place child locations as points / freehand lines / polygon regions), audit trail of every edit, and an in-app how-to FAQ.
